...
plot(g, os.path.join(path_script, '..', 'results', 'network'+sys.argv[1]+'.svg'), vertex_label=g.vs["name"], vertex_label_size=10, vertex_label_color="black",
...
plot(cl, os.path.join(path_script, '..', 'results', 'comunidades'+sys.argv[1]+'.svg'), mark_groups=True, vertex_label=g.vs["name"], vertex_label_size=10, vertex_label_color="black",
