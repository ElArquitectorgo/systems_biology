...
\begin{document}
	...
	\begin{backmatter}
		...
		\section*{Contribución de los autores}
			V.G.O : introducción; S.R.F.G : introducción; P.B.G : redacción de la introducción, creación de una plantilla del workflow y del script para conseguir la red de genes de StringDB, redacción de la metodología y redacción de una parte de la discusión; J.C.V.R : introducción
